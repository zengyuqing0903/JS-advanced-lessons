...
console.log(arr._proto_ === Array.prototype);//false
...
console.log(foo._proto_ === Function.prototype);//false
...
for(var k in obj){//只能遍历整个原理链上所有可遍历的属性
    console.log(k,obj[k]);
}

console.log(Object.keys(obj));//返回一个数组，包含自身所有可枚举的属性

console.log("x" in obj);//能够检查整个原理链上的属性，包括不可遍历的属性


//注意：以下例子只做了解，具体内容在对象属性特性章节和函数对象章节详细介绍
