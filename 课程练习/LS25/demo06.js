...
window.onload = function (e) {
    ...
    // 全为false：
    /*  点击div1：div1 click--red  
             target：<div id="div1"></div>  (含内层)
             this:<div id="div1"></div>  (含内层)
             true true false
        点击div2：div2 click--yellow
                 div1 click--red  
                 target：<div id="div2" style="background-color: black;"></div>  (含内层)
                 this:<div id="div1"></div>  (含内层)
                 true true false
        点击div3：div3 click--blue   
                 div2 click--yellow
                 div1 click--red  
